...
import { MessageSquare, Calendar as CalendarIcon, PlusCircle, Clock } from 'lucide-react';
...
const initialEntries = [
  {
    ...
    coachFeedback: 'Great job incorporating protein with each meal. Try adding more leafy greens to your lunch tomorrow.'
  },
  {
    id: '2',
    date: '2023-09-14',
...
const JournalEntryForm = ({ onCancel }: JournalEntryFormProps) => {
  const [date, setDate] = useState<Date>(new Date());
