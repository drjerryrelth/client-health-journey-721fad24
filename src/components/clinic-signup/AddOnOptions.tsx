...
interface AddOnOptionsProps {
  ...
  onToggleAddOn: (addOnId: string, checked: boolean) => void;
}

const AddOnOptions = ({ addOns, availableAddOns, onToggleAddOn }: AddOnOptionsProps) => {
          ...
          >
            <div className="flex items-start">
              <Checkbox 
                ...
                onCheckedChange={(checked) => onToggleAddOn(addon.id, checked === true)}
                className="mt-1 mr-2"
              />
              <div>
                <label 
